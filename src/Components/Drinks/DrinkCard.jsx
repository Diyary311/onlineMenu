...
function DrinkCard({ id, name, price, size, image, type = "drink" }) {
    ...
    return (
        <>
            <div
                className="flex flex-col items-center p-1 sm:p-2 rounded-md shadow-md cursor-pointer border border-teal-100 relative group"
                style={{
