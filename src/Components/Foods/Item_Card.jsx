...
function Item_Card({ id, name, price, size, image, type = "food" }) {
  ...
  return (
    <>
      <motion.div
        ...
        whileTap={{ scale: 0.95 }}
        className="flex flex-col items-center p-1 sm:p-2 rounded-md shadow-md cursor-pointer border border-orange-100 relative group"
        style={{
      ...
      >
        <div className="w-full flex justify-center mb-1 sm:mb-2">
          <img
            src={
              image
                ? `${API_BASE_URL}${image}` // ✅ prepend backend address
